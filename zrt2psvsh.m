function [ datPSVSH ] = zrt2psvsh( datZRT, a, B, p )
% [ datPSVSH ] = zrt2psvsh( datZRT, a, B, phi )
...
% phi       - ray parameter = sin(inc)/v where v is a or B
...
M = [(B^2 * p^2 - 0.5)/xa      ((p*B^2)/a)      0
            p*B          (0.5 - B^2 * p^2)/xB   0
             0                      0          0.5];
