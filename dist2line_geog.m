...
%   calculates the distance (in degrees!) perpendicular to and parallel to
%   (as measured from Q1) a line between geographic points Q1 [lat,lon] and
%   Q2 [lat,lon] of a series of points, P is a Nx2 vector of [lats,lons].
%   The discretization along the line is dr (default is 0.01 deg).
...
for ip = 1:Np
    ...
    % perp distance
    x1 = abs(asind(sind(gci)*sind(theta)));
    % par distance
